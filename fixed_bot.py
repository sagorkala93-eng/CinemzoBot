...
"""
CINEMZO.COM Telegram Bot - Fixed Webhook Implementation
"""
...
async def show_join_channel_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        logger.error(f"Error in show_join_channel_message: {e}")
...
async def show_main_interface(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        logger.error(f"Error in show_main_interface: {e}")
...
async def handle_movie_search(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        logger.error(f"Error in handle_movie_search: {e}")
...
async def search_and_send_movie(update: Update, context: ContextTypes.DEFAULT_TYPE, movie_name: str):
    ...
    try:
        ...
        logger.error(f"Error in search_and_send_movie: {e}")
        try:
...
def webhook():
    ...
    try:
        ...
        return jsonify({"status": "error", "message": str(e)}), 200  # Return 200 to avoid Telegram retries
